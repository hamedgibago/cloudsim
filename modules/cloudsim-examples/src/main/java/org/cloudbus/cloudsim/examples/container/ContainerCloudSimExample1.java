...
public class ContainerCloudSimExample1 {
    ...
    public static List<ContainerCloudlet> createContainerCloudletList(int brokerId, int numberOfCloudlets)
    	...
    	//Enumeration<URL> url;
			...
			//url = ContainerCloudSimExample1.class.getClassLoader().getResources("workload/planetlab");
    	//URL url= ContainerCloudSimExample1.class.getClassLoader().getResource("/workload/planetlab");
    	///////////////////end of code test khodam
    	
    	//main code
        //String inputFolderName = ContainerCloudSimExample1.class.getClassLoader().getResource("workload/planetlab").getPath();
    	String inputFolderName ="C:/Users/Station - Windows 10/eclipse-workspace/cloudsim-master/modules/cloudsim-examples/src/main/resources/workload/planetlab";
